...
import { ScrollView,View, Text,Image,StyleSheet, TouchableHighlight,Alert} from 'react-native';
    ...
    _llave = (dato) => {
        ...
        return(
            <View style={styles.container}> 
                ...
                />
                <ScrollView >
                <TouchableHighlight onPress={this._detalles} underlayColor='#f1c40f'>
                    <View>
                    {/*this.state.titular.video != ''?
                        ...
                        <Image
                            style={{height: 150}}
                            resizeMode="stretch"
                            source={{uri:props.datosTitular.img}}
                        />
                        <Text style={styles.titular} >{props.datosTitular.titulo}</Text>
                        <Text style={styles.fecha} >{props.datosTitular.fecha}</Text> 
                    </View>
